...
import org.springframework.samples.petclinic.order.OrderDto;
import org.springframework.samples.petclinic.order.OrderExtendedDto;
...
public class KafkaConfiguration {
    ...
    @Bean
    DefaultKafkaProducerFactory<String, OrderDto> orderProducerFactory(KafkaProperties properties) {
        Map<String, Object> producerProperties = properties.buildProducerProperties(null);
        producerProperties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
    ...
    @Bean
    KafkaTemplate<String, OrderDto> orderKafkaTemplate(DefaultKafkaProducerFactory<String, OrderDto> orderProducerFactory) {
