...
INSERT INTO order_item (id, service_id, service_name, price, count, cost, order_, order__key) VALUES (1, 1, 'Grooming', 75.00, 1, 75.00, 1, 2);
INSERT INTO order_item (id, service_id, service_name, price, count, cost, order_, order__key) VALUES (2, 2, 'Pet Checkup', 500.00, 1, 500.00, 1, 1);

INSERT INTO order_ (id, total_cost, created_date, last_modified_date, owner_id, pet_id) VALUES (2, 100.00, NOW(), NOW(), 1, 1);
INSERT INTO order_item (id, service_id, service_name, price, count, cost, order_, order__key) VALUES (3, 1, 'Grooming', 75.00, 1, 75.00, 2, 1);
INSERT INTO order_item (id, service_id, service_name, price, count, cost, order_, order__key) VALUES (4, 3, 'Vaccination', 25.00, 1, 25.00, 2, 2);
